...
public class PcmsProject {
    ...
    public void setRequestTelphone(String requestTelphone) {
        this.requestTelphone = requestTelphone == null ? null : requestTelphone.trim();
    }
    ...
    public void setRequestEmail(String requestEmail) {
        this.requestEmail = requestEmail == null ? null : requestEmail.trim();
    }
    ...
    public void setFinanceUser(String financeUser) {
        this.financeUser = financeUser == null ? null : financeUser.trim();
    }
    ...
    public void setRequestCreateTime(String requestCreateTime) {
        this.requestCreateTime = requestCreateTime == null ? null : requestCreateTime.trim();
    }
    ...
    public void setRequestEndTime(String requestEndTime) {
        this.requestEndTime = requestEndTime == null ? null : requestEndTime.trim();
    }
